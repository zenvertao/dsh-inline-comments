	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			function floatAnchor(node){
				...
				while (target && target !== document.body && clipsChildren(target) && target.parentElement) target = target.parentElement;
