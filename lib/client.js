window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function apply(ctx) {
			...
			if (vv){ vv.addEventListener("scroll", drawAll); vv.addEventListener("resize", drawAll); }
			...
			return function(){
				...
				if (vv){ vv.removeEventListener("scroll", drawAll); vv.removeEventListener("resize", drawAll); }
			};
		}
