window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var CSS = ".ic-root{position:fixed;inset:0;pointer-events:none;z-index:2147483000;}"
			...
			+ ".ic-badge{position:absolute;pointer-events:auto;min-width:20px;height:20px;padding:0 6px;border-radius:10px;background:var(--dsw-alias-state-business-primary,#3b6fff);color:#fff;font:700 11px/20px -apple-system,system-ui,sans-serif;display:grid;place-items:center;cursor:pointer;border:1.5px solid rgba(255,255,255,.95);box-sizing:border-box;box-shadow:0 2px 5px rgba(0,0,0,.28);}"
